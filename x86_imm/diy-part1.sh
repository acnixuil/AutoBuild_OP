...
immortalwrt_dev=immortalwrt_x86-64_\${dev_version}_bios.img.gz
immortalwrt_dev_uefi=immortalwrt_x86-64_\${dev_version}_uefi.img.gz
cd bin/targets/x86/64
# md5sum \$immortalwrt_dev > immortalwrt_bios.md5
# md5sum \$immortalwrt_dev_uefi > immortalwrt_uefi.md5
exit 0
EOF