...
if [[ "$REPO_URL" == *"lede"* || "$REPO_URL" == *"ipq6000"* ]]; then
  git clone --depth=1 --single-branch -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git luci-theme-argon
  git clone --depth=1 --single-branch -b 18.06 https://github.com/jerrykuku/luci-app-argon-config.git luci-app-argon-config
  git clone --depth=1 --single-branch -b main https://github.com/ophub/luci-app-amlogic.git luci-app-amlogic
else
  git clone --depth=1 --single-branch -b master https://github.com/jerrykuku/luci-theme-argon.git luci-theme-argon
  git clone --depth=1 --single-branch -b master https://github.com/jerrykuku/luci-app-argon-config.git luci-app-argon-config
  git clone --depth=1 --single-branch -b main https://github.com/morytyann/OpenWrt-mihomo.git mihomo
  git clone --depth=1 --single-branch -b main https://github.com/VIKINGYFY/homeproxy.git homeproxy
fi
